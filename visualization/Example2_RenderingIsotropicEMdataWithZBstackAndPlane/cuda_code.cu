...
extern "C"{
__global__ void renderucharucharshortfloat4float4float4float3float3(RGBA* rb, VIVALDI_DATA_RANGE* rb_DATA_RANGE, uchar* Fish, VIVALDI_DATA_RANGE* Fish_DATA_RANGE, uchar* Mask, VIVALDI_DATA_RANGE* Mask_DATA_RANGE, short* Brain, VIVALDI_DATA_RANGE* Brain_DATA_RANGE, int x_start, int x_end, int y_start, int y_end, float4* transf, VIVALDI_DATA_RANGE* transf_DATA_RANGE, float4* zbtransf, VIVALDI_DATA_RANGE* zbtransf_DATA_RANGE, int min_val, int max_val, float4* input_col, VIVALDI_DATA_RANGE* input_col_DATA_RANGE, float3* plane_norm, VIVALDI_DATA_RANGE* plane_norm_DATA_RANGE, float3* plane_loc, VIVALDI_DATA_RANGE* plane_loc_DATA_RANGE){
...
__global__ void renderucharucharshortfloat4float4float4float3float3_checker(RGBA* rb, VIVALDI_DATA_RANGE* rb_DATA_RANGE, uchar* Fish, VIVALDI_DATA_RANGE* Fish_DATA_RANGE, uchar* Mask, VIVALDI_DATA_RANGE* Mask_DATA_RANGE, short* Brain, VIVALDI_DATA_RANGE* Brain_DATA_RANGE, int x_start, int x_end, int y_start, int y_end, float4* transf, VIVALDI_DATA_RANGE* transf_DATA_RANGE, float4* zbtransf, VIVALDI_DATA_RANGE* zbtransf_DATA_RANGE, int min_val, int max_val, float4* input_col, VIVALDI_DATA_RANGE* input_col_DATA_RANGE, float3* plane_norm, VIVALDI_DATA_RANGE* plane_norm_DATA_RANGE, float3* plane_loc, VIVALDI_DATA_RANGE* plane_loc_DATA_RANGE){
