...
extern "C"{
__global__ void cutSkeletonucharfloat3int(uchar* rb, VIVALDI_DATA_RANGE* rb_DATA_RANGE, uchar* volume, VIVALDI_DATA_RANGE* volume_DATA_RANGE, int x_start, int x_end, int y_start, int y_end, float3* ptr_list, VIVALDI_DATA_RANGE* ptr_list_DATA_RANGE, int length, int* colorPnt, VIVALDI_DATA_RANGE* colorPnt_DATA_RANGE){
    ...
    float data;
    float3 sample_coord;
    sample_coord = point_query_1d<float3>(ptr_list, x, ptr_list_DATA_RANGE);
    sample_coord.y = y;
    data = point_query_3d<float>(volume, sample_coord, volume_DATA_RANGE);
    ...
    if( data > 0){
        ...
        rb[(x-rb_DATA_RANGE->buffer_start.x)+(y-rb_DATA_RANGE->buffer_start.y)*(rb_DATA_RANGE->buffer_end.x-rb_DATA_RANGE->buffer_start.x)] = data;
        return;
...
__global__ void cutSkeletonucharfloat3int_checker(uchar* rb, VIVALDI_DATA_RANGE* rb_DATA_RANGE, uchar* volume, VIVALDI_DATA_RANGE* volume_DATA_RANGE, int x_start, int x_end, int y_start, int y_end, float3* ptr_list, VIVALDI_DATA_RANGE* ptr_list_DATA_RANGE, int length, int* colorPnt, VIVALDI_DATA_RANGE* colorPnt_DATA_RANGE){
