...
D = importdata('D:\Dropbox (Personal)\MATLAB\Data\160811t1242_130201zf142_160515SWiFT_ANNOTsymmetry_IGNblacklistsymblack_LongestLeafToLeaf_20umLenThresh_PHYScoord_rootToNaN.txt');
S = importdata('D:\Dropbox (Personal)\MATLAB\Data\160811t1242_130201zf142_160515SWiFT_ANNOTsymmetry_IGNblacklistsymblack_LongestLeafToLeaf_20umLenThresh_UniqSkels.txt');
...
% for pairindex = 1:npairs
    ...
    samples = 300;
    [ms,~,~] = symmetrymidpoints(P,TP,Q,TQ,samples,0.99,rg);
...
save(strcat(Prefix,'sp.mat'),'sp','-v7.3') % symmetry plane points
save(strcat(Prefix,'V.mat'),'V','-v7.3') % symmetry plane perpendicular vector
save(strcat(Prefix,'computeGlobalSymmetryPlane_results.mat'),'-v7.3')
