...
if ~strcmp(p.GridLines,'none')
    ...
    for i = 0:diff(xlim)
        line('Parent',p.hAxes,'XData',[i i]+.5,'YData',ylim,'LineStyle',p.GridLines,'Color','w','LineWidth',2);
    end
    for i = 0:diff(ylim)
        line('Parent',p.hAxes,'XData',xlim,'YData',[i i]+.5,'LineStyle',p.GridLines,'Color','w','LineWidth',2);
    end
end
end
